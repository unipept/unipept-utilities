...
generate_tables() {
    ...
    git clone "https://github.com/unipept/unipept-database.git" "${SCRATCH_DIR:?}/unipept-database"
...
build_suffix_array() {
    ...
    git clone "https://github.com/unipept/unipept-index.git" "${SCRATCH_DIR:?}/unipept-index"    
